...
CREATE TABLE IF NOT EXISTS `users_diets_links` (
`id`	INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE,
`users_diet_id`	INTEGER NOT NULL,
`special_condition_id`	INTEGER NOT NULL
);
INSERT INTO `users_diets_links` VALUES (1,1,1),
(2,1,4);
...
INSERT INTO `users` VALUES (1,'collin602','Collin','Coutinho','password','226319377',1,'S10 3AU',1);
